...
//    }
    ...
    public void writeOut() {
        ...
        try {
            ...
            // PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("Classifier/ML-Model/Test/test_vectors_gyro_pre.txt", true)));
        ...
        try {
            ...
            //PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("Classifier/ML-Model/Test/test_vectors_gyro_post.txt", true)));
        ...
        try {
            ...
            //PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("Classifier/ML-Model/Test/test_vectors_acc_pre.txt", true)));
        ...
        try {
            ...
            //PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("Classifier/ML-Model/Test/test_vectors_acc_post.txt", true)));
        ...
        try {
            ...
            //PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("Classifier/ML-Model/Test/test_vectors_rot_pre.txt", true)));
        ...
        try {
            ...
            //PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("Classifier/ML-Model/Test/test_vectors_rot_post.txt", true)));
        ...
        try {
            ...
            //PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("Classifier/ML-Model/Test/test_vectors_comp_pre.txt", true)));
        ...
        try {
            ...
            //PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("Classifier/ML-Model/Test/test_vectors_comp_post.txt", true)));
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("./Classifier/ML-Model-Copy/Result/result.txt")))
        {
            ...
            while ((sCurrentLine = br.readLine()) != null) {
                ...
                ResultDialog dialog = new ResultDialog(new JFrame(), sCurrentLine + " shot");
